...
import { TrendingUp, Calendar as CalendarIcon, Award, AlertTriangle, Target, Users } from 'lucide-react';
...
export function ChallengeStats({ challenge, userId, open, onOpenChange }: ChallengeStatsProps) {
